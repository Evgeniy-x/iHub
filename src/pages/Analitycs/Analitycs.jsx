...
const Analitycs = () => {
  ...
  const totalPsychologist = allItems.filter(
    (e) => e.specialty === "psychologist"
  ); // get only psychologist items
  const totalPsychotherapist = allItems.filter(
    (e) => e.specialty === "psychotherapist"
  ); // get only psychotherapist  items
  const totalPsychiatrist = allItems.filter(
    (e) => e.specialty === "psychiatrist"
  ); // get only psychiatrist items
  ...
  return (
    <div className="analityc__container">
      ...
      <div className="analityc__content">
        ...
        <AnalitycItem
          title="Total psychologist"
          result={totalPsychologist.length}
        />
        <AnalitycItem
          title="Total psychotherapist"
          result={totalPsychotherapist.length}
        />
        <AnalitycItem
          title="Total psychiatrist"
          result={totalPsychiatrist.length}
        />
